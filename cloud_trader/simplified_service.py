...
class SimplifiedTradingService:
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.warning(
                f"⚠️ Vertex AI client initialization failed: {e}. Running in limited mode."
            )
        ...
        self.agent_capital = float(
            os.getenv("AGENT_CAPITAL", str(self.total_capital / 6))
    ...
    async def get_system_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "total_capital": self.total_capital,
            "active_agents": len(
                [a for a in self.agent_status.values() if a["status"] == "active"]
            ),
            "features": [
