"""Vertex AI custom job entrypoint for Lag-Llama Degenerate fine-tuning."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fine-tune Lag-Llama Degenerate agent")
    ...
    parser.add_argument("--output-dir", default="/gcs/artifacts/lagllama")
    ...
    train_language_model(dataset, profile, run_name="lagllama-degenerate")
