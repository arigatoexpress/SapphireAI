"""Vertex AI custom job entrypoint for Qwen Adaptive fine-tuning."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fine-tune Qwen Adaptive agent")
    ...
    parser.add_argument("--output-dir", default="/gcs/artifacts/qwen")
    ...
    train_language_model(dataset, profile, run_name="qwen-adaptive")
