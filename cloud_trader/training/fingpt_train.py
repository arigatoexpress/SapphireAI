"""Vertex AI custom job entrypoint for FinGPT Alpha fine-tuning."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fine-tune FinGPT Alpha agent")
    ...
    parser.add_argument("--output-dir", default="/gcs/artifacts/fingpt")
    parser.add_argument("--base-model", default="FinGPT/fingpt-falcon-7b")
    ...
    train_language_model(dataset, profile, run_name="fingpt-alpha")
