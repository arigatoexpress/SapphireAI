...
class ComplianceAuditor:
    ...
    async def generate_compliance_report(self) -> Dict[str, Any]:
        ...
        report = {
            ...
            'compliance_level': self.compliance_level.value,
            'overall_status': 'compliant' if compliance_results['critical_violations'] == 0 else 'non_compliant',
            'summary': {
        ...
        if compliance_results['critical_violations'] > 0:
            report['recommendations'].append("Immediate action required for critical compliance violations")
        if compliance_results['violations_found'] > 5:
            report['recommendations'].append("Multiple compliance violations detected - review system configuration")
